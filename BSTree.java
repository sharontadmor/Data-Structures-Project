 ...
 * public class BSTree
 * <p>
 * This class represents a binary search tree with integer keys and boolean values.
 * <p>
 * 
...
public class BSTree {
	 ...
	 * @param parent
	 * @param child  time complexity: O(1)
	 */
	 ...
	 * 
	 * @param node time complexity: O(log n)
	 */
	 ...
	 * 
	 * @param node
	 * @return curr AVL node from which to start rebalancing the tree. time
	 *         complexity: O(log n)
	 */
	 ...
	 * deletes leaf node.
	 * 
	 * @param node time complexity: O(1)
	 */
	 ...
	 * @pre empty() == false
	 * @param node
	 * @return AVL node with the smallest key in the given node's subtree. time
	 *         complexity: O(log n)
	 */
	...
	/**
	 * @return item with the smallest key in the tree. time complexity: O(1)
	 */
	...
	/**
	 * @param node
	 * @return AVL node with the largest key in the given node's subtree. time
	 *         complexity: O(log n)
	 */
	...
	/**
	 * @return item with the largest key in the tree. time complexity: O(1)
	 */
	 ...
	 * However, the implementation of succPrefixXor is the following:
